            ...
            <div class="card stat-card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 ms-xl-4 text-truncate">
                            <p class="stat-label mb-1 mb-xl-2">Total de Máquinas</p>
            ...
            <div class="card stat-card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 ms-xl-4 text-truncate">
                            <p class="stat-label mb-1 mb-xl-2">Máquinas em Serviço</p>
            ...
            <div class="card stat-card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 ms-xl-4 text-truncate">
                            <p class="stat-label mb-1 mb-xl-2">Total de Operadores</p>
            ...
            <div class="card stat-card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 ms-xl-4 text-truncate">
                            <p class="stat-label mb-1 mb-xl-2">Manutenções Pendentes</p>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    @forelse($usosRecentes as $uso)
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center p-3 mb-2 bg-light rounded gap-2">
