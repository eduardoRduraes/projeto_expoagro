        ...
        <table class="table table-bordered table-striped">
            ...
            @foreach($manutencoes as $manutencao)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('manutencoes.show', $manutencao->id) }}" class="btn btn-sm btn-info">Ver</a>
                        <a href="{{ route('manutencoes.edit', $manutencao->id) }}" class="btn btn-sm btn-warning">Editar</a>
                        <form action="{{ route('manutencoes.destroy', $manutencao->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Tem certeza que deseja excluir?')">
                            @csrf
                            @method('DELETE')
